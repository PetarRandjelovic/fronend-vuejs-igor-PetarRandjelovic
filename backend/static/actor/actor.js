...
function init() {
    ...
    fetch('http://127.0.0.1:8090/admin/actor', {
        headers: {
        ...
        .then( data => {
          ...
          // console.log(data);
           ...
           if(data.msg){
            ...
            const lst = document.getElementById('actorLst');
//37 linija promeni
            ...
            data.forEach( el => {
                ...
                <a href="/admin/actor/updateActor/${el.id}" class="btn btn-primary update"> 
                   Update
                </a>
    ...
    document.getElementById('actorBtn').addEventListener('click', e => {
        e.preventDefault();
        ...
        fetch('http://127.0.0.1:8090/admin/actor', {
           ...
           /// .then( res => res.json() )
            .then( data => {
                ...
                document.getElementById('actorLst').innerHTML += `<tr> <td> ${data.id} </td> <td> ${data.firstName} </td>  <td> ${data.lastName} </td> </tr> 
                <a href="/admin/actor/updateActor/${data.id}" class="btn btn-primary update">
                   Update
                </a>
...
function deleteUser(obj) {
    ...
    if (result) {
        ...
        var table = document.getElementById('actorLst');
        let i, row, colId;
        console.log(id);
